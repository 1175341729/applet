...
public class Task {
     ...
     * @mbggenerated
     */
    public Task(Integer id, String taskName, String taskAddress, String propertyCompany, String taskNumber, String province, String city, String dockingPerson, String creator, Date createTime, Date completionTime, Byte status, BigDecimal bonus, String supplierId, String versionNum, String dockingPhone) {
        this.id = id;
